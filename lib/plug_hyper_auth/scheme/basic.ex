...
defmodule PlugHyperAuth.Scheme.Basic do
  ...
  ## Examples
    ...
    iex> PlugHyperAuth.Scheme.Basic.process_authorization Plug.Test.conn(:get, "/"), ["AXBlcC5hDWUGcGFzc3dvcmQ="], %{}, []
    nil
  ...
  Value of www-authenticate for scheme Basic.
    ...
    iex> PlugHyperAuth.Scheme.Basic.request_authenticate Plug.Test.conn(:get, "/"), []
    "basic"

    iex> PlugHyperAuth.Scheme.Basic.request_authenticate Plug.Test.conn(:get, "/"), realm: "admin@localhost"
