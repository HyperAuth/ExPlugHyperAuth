defmodule HyperAuth.Scheme.Digest do
  ...
  ## Examples
    ...
    iex> HyperAuth.Scheme.Digest.process_authorization Plug.Test.conn(:get, "/"), [], %{}, []
    nil
  ...
  ## Examples
    ...
    iex> HyperAuth.Scheme.Digest.sha384_encode64 "Test"
  ...
  ## Examples
    ...
    iex> HyperAuth.Scheme.Digest.verify_timestamp 20, 15, 5
    true

    iex> HyperAuth.Scheme.Digest.verify_timestamp 23, 15, 5
    false
    ...
    ...> DateTime.utc_now()
    ...> |> DateTime.to_unix()
    ...> |> HyperAuth.Scheme.Digest.verify_timestamp(old_timestamp, 10)
    true
  """
  ...
  ## Examples
    ...
    ...> |> DateTime.to_unix()
    ...> old_timestamp
    ...> |> HyperAuth.Scheme.Digest.verify_timestamp(10)
    true
  """
  ...
  ## Examples
    ...
    iex> www_authenticate = HyperAuth.Scheme.Digest.request_authenticate Plug.Test.conn(:get, "/"), realm: "admin@localhost"
